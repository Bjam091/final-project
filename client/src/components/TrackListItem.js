...
const TrackListItem = function (props) {

  const token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE1NzUzMjU2MDQsInN1YiI6M30.hDPkZGW8a8f8tpjgDKrenzrqHqFhSsbbfBMMKKmfXOU'
      ...
      <div className='trackitem'>
        <div className='flex'>
          ...
          <div className='track-text'>
            ...
            <div className='liked-track'><button type="button" className='like-button' onClick={fetchCurrentSong}>
...
export default connect(state => state)(TrackListItem);